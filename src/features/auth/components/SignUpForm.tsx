...
import { InputOTP, InputOTPGroup, InputOTPSeparator, InputOTPSlot } from "~/common/components/input-otp";
import { useAuth } from "~/features/auth/hooks/useAuth";
import { signUpSchema, verifyEmailSchema } from "~/features/schemas/auth.schema";

export default function SignUpForm() {
  const { signUpWithEmail, signInWithGoogle, error, isVerifying, verifyEmail } = useAuth();
        ...
        <Card className="w-[350px]">
          ...
          <CardContent>
            ...
            <div className="grid gap-2">
              ...
              <InputOTP maxLength={6} value={code} onChange={(value) => setValue("code", value)} >
                <InputOTPGroup>
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-2">
      ...
      <div className="grid gap-2">
        ...
        <PasswordInput id="password" placeholder="***********" showPasswordToggle={true} {...register("password")} />
        <ErrorMessage message={errors.password?.message} />
      </div>
      <div className="grid gap-2">
        <Label htmlFor="confirmPassword">Confirm Password</Label>
        <PasswordInput id="confirmPassword" placeholder="***********" showPasswordToggle={true} {...register("confirmPassword")} />
