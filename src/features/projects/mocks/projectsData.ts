...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Create a weather application for iOS and Android using React Native",
  ...
  },
  {
    ...
    description: "Design and build a RESTful API for a task management application",
