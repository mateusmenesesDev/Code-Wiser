...
import type { ProjectCard } from '~/features/projects/types/Projects.type';
...
const project: ProjectCard = {
	...
	learningOutcomes: [
		{ completed: false, id: '1', title: 'Learn React' },
		{ completed: false, id: '2', title: 'Learn Node.js' },
		{ completed: false, id: '3', title: 'Learn MongoDB' },
		{ completed: false, id: '4', title: 'Learn Express' },
		{ completed: false, id: '5', title: 'Learn Stripe API' }
	],
	startDate: new Date('2023-07-01'),
	endDate: new Date('2023-08-26'),
	milestones: [
		{ completed: false, id: '1', title: 'Project Setup' },
		{ completed: false, id: '2', title: 'User Authentication' },
		{ completed: false, id: '3', title: 'Product Catalog' },
		{ completed: false, id: '4', title: 'Shopping Cart' },
		{ completed: false, id: '5', title: 'Checkout Process' },
		{ completed: false, id: '6', title: 'Admin Panel' },
		{ completed: false, id: '7', title: 'Final Testing and Deployment' }
	],
	discussions: [
		{
			id: '1',
