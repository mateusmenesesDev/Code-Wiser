...
-- CreateEnum
CREATE TYPE "MentorshipStatus" AS ENUM ('ACTIVE', 'INACTIVE');

-- CreateEnum
CREATE TYPE "MentorshipType" AS ENUM ('MONTHLY', 'QUARTERLY', 'SEMIANNUAL');
...
CREATE TABLE "User" (
    ...
    "mentorshipStatus" "MentorshipStatus" NOT NULL DEFAULT 'INACTIVE',
    "mentorshipType" "MentorshipType" DEFAULT 'MONTHLY',
    "mentorshipStartDate" TIMESTAMP(3),
    "mentorshipEndDate" TIMESTAMP(3),
...
-- CreateIndex
CREATE UNIQUE INDEX "ProjectImage_uploadId_key" ON "ProjectImage"("uploadId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Epic_projectTemplateId_title_key" ON "Epic"("projectTemplateId", "title");

-- CreateIndex
CREATE UNIQUE INDEX "Epic_projectId_title_key" ON "Epic"("projectId", "title");

-- CreateIndex
CREATE UNIQUE INDEX "Sprint_projectTemplateId_title_key" ON "Sprint"("projectTemplateId", "title");
...
-- AddForeignKey
ALTER TABLE "Sprint" ADD CONSTRAINT "Sprint_projectTemplateId_fkey" FOREIGN KEY ("projectTemplateId") REFERENCES "ProjectTemplate"("id") ON DELETE SET NULL ON UPDATE CASCADE;
